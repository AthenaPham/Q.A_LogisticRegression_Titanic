...
FN = confusion[1][0]  # cua co la FN 0,0
TN = confusion[0][1]  # TN là 1, 0
TP = confusion[1][1]
FP = confusion[0][1]
...
# PART2: tao menu cho tung part
st.title("Data Science")
st.write("### Titanic Survivel Prediction Project")

menu = ["Overview", "Build Project", "New Predict"]
...
if choice == "Overview":
    ...
    fig, ax = plt.subplots()
    ax.bar(['Flase Negative', 'True Negative', 'True Positive', 'False Positive'],
            [FN, TN, TP, FP])
    st.pyplot(fig)
    ...
    sibsp = st.slider('Sinlings', 0, max_sibsp, 1)
